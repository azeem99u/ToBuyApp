package com.azeem.tobuyapp.database
...
import com.azeem.tobuyapp.database.dao.CategoryEntityDao
...
abstract class AppDatabase : RoomDatabase() {
    companion object {
        ...
        fun getDatabase(context: Context): AppDatabase {
            ...
            appDatabase = Room
                .databaseBuilder(context.applicationContext, AppDatabase::class.java, "to_buy_database")
